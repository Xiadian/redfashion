...
//拼接%d到10;
#define PickView_body  @"http://api.chuandazhiapp.com/v1/channels/%d/items?gender=2&generation=2&limit=20&offset=0"
#define Zhuanti_url @"http://api.chuandazhiapp.com/v1/collections/%d/posts?gender=2&generation=2&limit=20&offset=0"
